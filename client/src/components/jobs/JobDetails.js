...
const JobDetails = ({   getJobById, job: { job }, match }) => {
  useEffect(() => {
            ...
            <div className="col-xl-10 col-lg-11 mt-4 ml-xxl-32 ml-xl-15 dark-mode-texts">
              <div className="mb-9">
                <a className="d-flex align-items-center ml-4" href="dashboard-main.html"> <i className="icon icon-small-left bg-white circle-40 mr-5 font-size-7 text-black font-weight-bold shadow-8">
                  </i><span className="text-uppercase font-size-3 font-weight-bold text-gray">Back to job board</span></a>
              </div>
            </div>
            {/* back Button End */}
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      <div className="media align-items-center">
                        ...
                        {/* media texts start */}
                        <div>
                          <h3 className="font-size-6 mb-0">{job.titleJob}</h3>
                          <span className="font-size-3 text-gray line-height-2"></span>
                        </div>
                        {/* media texts end */}
                      </div>
                      {/* media end */}
                  ...
                  <div className="row pt-9">
                    <div className="col-12">
                      ...
                      <div className="card-btn-group">
                        <Link to="{`/job/${_id}`}"><a className="btn btn-green text-uppercase btn-medium rounded-3 w-180 mr-4 mb-5" href="#">Apply to this job</a></Link>
                        <a className="btn btn-outline-mercury text-black-2 text-uppercase h-px-48 rounded-3 mb-5 px-5" href="#">
                          <i className="icon icon-bookmark-2 font-weight-bold mr-4 font-size-4" /> Save job</a>
                      </div>
                      {/* card-btn-group end */}
                    </div>
                  </div>
...
export default connect(mapStateToProps, {  getJobById })(JobDetails);
