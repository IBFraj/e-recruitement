...
import { login1 } from '../../actions/authrh';

const Loginrh = ({ login1, isAuthenticated1 }) => {
...
const mapStateToProps = state => ({
  isAuthenticated1: state.authrh.isAuthenticated1
});

export default connect(mapStateToProps, { login1 })(Loginrh);
